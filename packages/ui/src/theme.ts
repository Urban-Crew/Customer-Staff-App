...
/** `squircle` is the one shared corner radius for every raised surface — inputs and buttons alike. */
export const radii = { sm: 10, md: 14, lg: 20, xl: 28, squircle: 16, pill: 999 } as const;
